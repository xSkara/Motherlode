...
[module: SuppressMessage("StyleCop.CSharp.DocumentationRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.LayoutRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.ReadabilityRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.NamingRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.OrderingRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCop.CSharp.SpacingRules", "*", Justification = "The code is from an external source.")]
[module: SuppressMessage("StyleCopPlus.StyleCopPlusRules", "*", Justification = "The code is from an external source.")]
...
namespace Motherlode.Common
{
          ...
          ICollection
    {
        ...
        ///     <see cref="T:ReadOnlyDictionary{TKey,TValue}"></see>.
        /// </summary>
        /// <value>
        ///     A <see cref="Dictionary{TKey,TValue}.KeyCollection" />
        ///     containing the keys.
        /// </value>
        /// <returns>
        ///     A
        ...
        /// <summary>
        ///     Determines whether the <see cref="T:ReadOnlyDictionary`2" />
    ...
    internal sealed class ReadOnlyDictionaryDebugView<TKey, TValue>
    {
        ...
        public KeyValuePair<TKey, TValue>[] Items
        {
            get
            {
                var array = new KeyValuePair<TKey, TValue>[this.dict.Count];
    ...
    public static class ReadOnlyDictionaryExtension
    {
        ...
        public static ReadOnlyDictionary<TKey, TValue> AsReadOnly<TKey, TValue>(this IDictionary<TKey, TValue> obj)
        {
            return new ReadOnlyDictionary<TKey, TValue>(obj);
        }
